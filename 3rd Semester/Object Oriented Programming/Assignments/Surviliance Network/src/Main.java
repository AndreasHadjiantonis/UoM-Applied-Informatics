...
public class Main {
	...
	public static void main(String[] args) {
		...
		comms[7] = new PhoneCall("0030210567888", "00478484222222", 22, 10, 2022, 510);
		...
		comms[14] = new PhoneCall("0030210567888", "00478484222222", 22, 10, 2022, 510);
...
//		registry.printSuspectsFromCountry("Spain");
		s1.printPossiblePartners();
		s2.printPossiblePartners();
		s3.printPossiblePartners();
		s4.printPossiblePartners();
		System.out.println(s4.possiblePartners.size());
